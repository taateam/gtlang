...
bool is_inline_conditional_expr(Mixed _tokens_line) {
...
Mixed parse_inline_conditional_expr(Mixed _tokens_outside_brackets) {
	...
	_tokens_outside_brackets.resetKeys();
	long _i = 0;
